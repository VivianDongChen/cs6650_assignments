...
echo ""
echo "WebSocket URLs:"
echo "  1. ws://44.254.79.143:8080/chat-server/chat"
echo "  2. ws://50.112.195.157:8080/chat-server/chat"
echo "  3. ws://54.214.123.172:8080/chat-server/chat"
echo "  4. ws://54.190.115.9:8080/chat-server/chat"
echo ""
